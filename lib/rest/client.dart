...
class ApiRequest {
  ...
  //   Function(CancelToken cancelToken)? onCancelTokenGenerate,
  // }) async {
  //   print("GET $url");
  ...
  //       onCancelTokenGenerate != null ? onCancelTokenGenerate(cancelToken) : null;

  //       var resp = await _dio().get(url, queryParameters: data, cancelToken: cancelToken);
  //       changeLoadingStatus(isLoading, false);
  //       if (resp.statusCode == 200){
  //         print("onSuccess : ${resp.data}");
  //         onSuccess(resp.data);
  //       }else{
  //         print("errorModel : ${resp.data}");
  ...
  //         } else {
  //           DialogUtil.errorAlertDialog(message: BaseErrorModel.fromJson(resp.data).message ?? "Something went wrong");
  //         }
  //       }
